...
public class Controller_systeme implements Initializable {
    @FXML
    ...
    public void supprimer(){
        ...
        try {
            ...
            Mystat.executeQuery("DELETE from SYSTEME WHERE designation='"+S+"'");
        }catch (Exception e){
    ...
    public void fill_list(){
        ...
        try {
            Connection Myconn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "equipement", "123");
            Statement Mystat = Myconn.createStatement();
            ResultSet MyRe = Mystat.executeQuery("select * from SYSTEME ORDER BY ID DESC ");
            while (MyRe.next()) {
    ...
    public void inserer() throws SQLException,Exception {
        ...
        if(S.equals("")){
            ...
            Connection Myconn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "equipement", "123");
            Statement Mystat = Myconn.createStatement();
            String sql = "INSERT INTO EQUIPEMENT.SYSTEME(DESIGNATION) VALUES\n" +
                    "('"+S+"')";
