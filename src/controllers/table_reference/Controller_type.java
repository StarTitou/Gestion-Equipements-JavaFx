...
public class Controller_type implements Initializable {
    @FXML
    ...
    try {
            ...
            Mystat.executeQuery("DELETE from TYPE WHERE designation='"+S+"'");
        }catch (Exception e){
    ...
    public void fill_list(){
        ...
        try {
            Connection Myconn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "equipement", "123");
            Statement Mystat = Myconn.createStatement();
            ResultSet MyRe = Mystat.executeQuery("select * from TYPE ORDER BY ID DESC ");
            while (MyRe.next()) {
    ...
    public void inserer() throws SQLException,Exception {
        ...
        if(S.equals("")){
            ...
            Connection Myconn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "equipement", "123");
            Statement Mystat = Myconn.createStatement();
            String sql = "INSERT INTO EQUIPEMENT.TYPE(DESIGNATION) VALUES\n" +
                    "('"+S+"')";
